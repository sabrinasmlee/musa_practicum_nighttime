...
dat_pred_agg <- 
  ...
  summarize(Night_visits = sum(Hrs19_0),
            ...
            # log_bars_a = log(sum(bars, na.rm = TRUE)/phl_area_sqmi),
            # log_rest_a = log(sum(restaurant, na.rm = TRUE)/phl_area_sqmi),
            ...
            # log_amuse_a = log(sum(amusement, na.rm = TRUE)/phl_area_sqmi),
...
reg1 <- lm(Night_visits_sqmi_log ~ ., data = st_drop_geometry(phl.training) %>%
