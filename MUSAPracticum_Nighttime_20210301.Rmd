...
```{r restaurants by district, width = 1200}
...
```{r art venues by district, width = 1200}
...
These maps have replaced our origin/destination maps that we presented last week. They are works in progress and we would love feedback on how to improve the readability.
